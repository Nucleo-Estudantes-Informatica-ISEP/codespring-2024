      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5">
        {juriCriteria.map((criteria, index) => (
          <div key={index} className="w-72 h-96 mx-auto">
            <div className="h-full flex flex-col justify-between bg-background rounded-xl overflow-hidden shadow-lg dark:shadow-none border border-none dark:border-solid">
